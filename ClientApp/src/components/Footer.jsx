          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-lg-3 col-md-6 footer-links">
                <h4>Our Services</h4>
                <ul>
                  <li><i className="bx bx-chevron-right"></i> <a href="#development">Software Development</a></li>
                  <li><i className="bx bx-chevron-right"></i> <a href="#testing">Testing and Optimisation</a></li>
                  <li><i className="bx bx-chevron-right"></i> <a href="#delivery">Delivery</a></li>
                </ul>
              </div>
