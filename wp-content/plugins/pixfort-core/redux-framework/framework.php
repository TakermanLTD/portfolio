...
//                            }
            ...
            public function section_menu( $k, $section, $suffix = "", $sections = array() ) {
                ...
                }elseif ( ( ( isset ( $this->args['icon_type'] ) && $this->args['icon_type'] == 'svg' ) || ( isset ( $section['icon_type'] ) && $section['icon_type'] == 'svg' ) ) || ( isset( $section['icon'] ) && strpos( $section['icon'], '/' ) !== false ) ) {
                    $icon = ( ! isset ( $section['icon'] ) ) ? '' : '<span class="svg_icon_type">' .  pix_load_inline_svg($section['icon']) . '</span>';
                } else {
