                    ...
                    Redux::setSection( $opt_name, array(
                        ...
                        'fields'     => array(
                            ...
                            array(
                                ...
                                'type'     => 'text',
                                'title'    => __( 'Custom Header Mobile Breakpoint', 'pixfort-core' ),
                                'desc' => __('Input a custom screen width in pixels to change the default breakpoint in which the mobile header will be displayed (the default is 992px).', 'pixfort-core'),
                                'default'  => '',
                            ),
