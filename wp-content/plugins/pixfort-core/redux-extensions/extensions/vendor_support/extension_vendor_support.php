        ...
        class ReduxFramework_extension_vendor_support {
            ...
            public function __construct( $parent = null ) {
                if ( empty( $this->extension_dir ) ) {
                    ...
                    // $this->extension_dir = PIXFORT_PLUGIN_DIR . 'redux-extensions/extensions/vendor_support/';
                    // $this->extension_url = PIXFORT_PLUGIN_URL . 'redux-extensions/extensions/vendor_support/';
                }
