...
*/
function sweetthemes_icon($params, $content) {
...
add_shortcode('mt_icon', 'sweetthemes_icon');
...
if ( is_plugin_active( 'js_composer/js_composer.php' ) ) {
  ...
  vc_map( array(
     "name" => esc_attr__("MT - Icon", 'sweetthemes'),
     "base" => "mt_icon",
     ...
     "params" => array(
        ...
        array(
          ...
          "holder" => "div",
          "class" => "",
          "heading" => esc_attr__("Icon Shadow Color", 'sweetthemes'),
        ...
        array(
          "group" => "Label Setup",
          "type" => "textfield",
          "heading" => esc_attr__("Label/margin-top", 'sweetthemes'),
