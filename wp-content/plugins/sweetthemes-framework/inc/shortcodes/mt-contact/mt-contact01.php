...
*/
function sweetthemes_shortcode_contact01($params, $content) {
    ...
    $html = '';
        ...
        // $html .= '<div class="success_message alert alert-success alert-dismissible" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><a href="#" class="alert-link">'.__('Thank you! We\'ll get back to you as soon as possible.','sweetthemes').'</a></div>';
        $html .= '</form>';
    return $html;
}
add_shortcode('shortcode_contact01', 'sweetthemes_shortcode_contact01');
...
if ( is_plugin_active( 'js_composer/js_composer.php' ) ) {
    ...
    vc_map( array(
     "name" => esc_attr__("MT - Contact", 'sweetthemes'),
     ...
     "params" => array(
        array(
          ...
          "type" => "colorpicker",
          "class" => "",
          "heading" => esc_attr__( "Contact button color", 'sweetthemes' ),
          "param_name" => "contact_button_color",
          "value" => "", //Default color
          "description" => esc_attr__( "Choose contact button color", 'sweetthemes' )
        ),
        array(
          "group" => "Animation",
          "type" => "dropdown",
