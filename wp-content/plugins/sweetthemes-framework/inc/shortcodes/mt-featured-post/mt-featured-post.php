...
*/
function sweetthemes_featured_post_shortcode($params, $content) {
    ...
    $thumbnail_src = wp_get_attachment_image_src( get_post_thumbnail_id( $postid ),'niva_featured_post_pic500x230' );
    $featured_post .= '<div class="latest-videos animateIn" data-animate="'.$animation.'">';
        ...
        $featured_post .= '<div class="video-title">';
            ...
            $featured_post .= '</div>';
        $featured_post .= '<div class="video-excerpt"><p>'.strip_tags(sweetthemes_excerpt_limit($content,20)).'</p></div>';
    $featured_post .= '</div>';
    return $featured_post;
}
add_shortcode('featured_post', 'sweetthemes_featured_post_shortcode');
...
if ( is_plugin_active( 'js_composer/js_composer.php' ) ) {
  ...
  vc_map( array(
     "name" => esc_attr__("MT - Featured post", 'sweetthemes'),
     "base" => "featured_post",
     ...
     "params" => array(
        array(
          "group" => "Options",
          "type" => "dropdown",
          "heading" => esc_attr__("Section heading icon", 'sweetthemes'),
          "param_name" => "icon",
          "std" => '',
          "holder" => "div",
          "class" => "",
        ...
        array(
           ...
           "holder" => "div",
           "class" => "",
           "heading" => esc_attr__("Please type a post ID", 'sweetthemes'),
           "param_name" => "postid",
           "value" => "",
           "description" => ""
        ),
