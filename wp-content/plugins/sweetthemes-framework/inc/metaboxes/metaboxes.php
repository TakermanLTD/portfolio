<?php
add_filter( 'cmb_meta_boxes', 'sweetthemes_metaboxes' );
function sweetthemes_metaboxes( array $meta_boxes ) {
...
$line_icons_font_i = array(
      ...
      */
      $meta_boxes['our_services_metaboxs'] = array(
            ...
            'title'      => __( 'MT Services Custom Options', 'sweetthemes' ),
            ...
            'fields'     => array(
                  array(
                        'name'       => __( 'Service Subtitle', 'sweetthemes' ),
                        'desc'       => __( 'Eg: Efficiently unleash cross-media information', 'sweetthemes' ),
                        'id'         => $prefix . 'service_subtitle',
                        'type'       => 'text',
                  ),
                  array(
                        'name'    => __( 'Select Icons Library', 'sweetthemes' ),
                        'desc'    => __( 'If "Yes" - Page Options will rewrite Theme Options', 'sweetthemes' ),
                        'id'      => $prefix . 'select_font',
                        'type'    => 'select',
                        'options' => array(
                            'font-awesome-icons' => __( 'Font Awesome', 'sweetthemes' ),
                            'simple-line-icons' => __( 'Simple Line Icons', 'sweetthemes' ),
                        ),
                  ...
                  array(
                        'name'    => __( 'Select a FontAwesome Icon', 'sweetthemes' ),
                        'desc'    => __( '', 'sweetthemes' ),
      ...
      */
      $meta_boxes['testimonials_metaboxs'] = array(
            ...
            'title'      => __( 'MT Testimonials Custom Options', 'sweetthemes' ),
            ...
            'fields'     => array(
                  array(
                        'name'    => __( 'Testimonial color', 'sweetthemes' ),
                        'desc'    => __( 'Set the color of the testimonial', 'sweetthemes' ),
                        'id'      => 'testimonial_color',
                        'type'    => 'colorpicker',
                        'default' => '#80A734'
                  ),
                  array(
                        'name'       => __( 'Job Position', 'sweetthemes' ),
                        'desc'       => __( 'Enter testimonial author job position', 'sweetthemes' ),
                        'id'         => 'job-position',
                        'type'       => 'text',
                  ),
                  array(
                        'name'       => __( 'Company', 'sweetthemes' ),
                        'desc'       => __( 'Enter testimonial author company name', 'sweetthemes' ),
                        'id'         => 'company',
                        'type'       => 'text',
                  )
            ),
      ...
      /**
      ||-> Metaboxes: For CPT - [jobs]
      */
      $meta_boxes['jobs_metaboxs'] = array(
            'id'         => 'jobs_metaboxs',
            'title'      => __( 'MT Jobs Custom Options', 'sweetthemes' ),
            ...
            'fields'     => array(
                  array(
                        'name'       => __( 'Job title', 'sweetthemes' ),
                        'desc'       => __( 'Bold the word/letter to change the color. The color option is in ST Jobs slider element', 'sweetthemes' ),
                        'id'         => 'job_title',
                        'type'    => 'wysiwyg',
                        'options' => array(
                  ...
                  array(
                        'name'       => __( 'Apply now text', 'sweetthemes' ),
                        'desc'       => __( 'Enter the apply now text', 'sweetthemes' ),
                        'id'         => 'aply_btn_text',
                        'type'       => 'text',
                  ),
                  array(
                        'name'       => __( 'Apply now link', 'sweetthemes' ),
                        'desc'       => __( 'Enter the apply now link', 'sweetthemes' ),
                        'id'         => 'aply_btn_link',
                        'type'       => 'text',
                  )
            ),
      ...
      */
      $meta_boxes['members_metaboxs'] = array(
            'id'         => 'members_metaboxs',
            'title'      => __( 'MT Members Custom Options', 'sweetthemes' ),
            ...
            'fields'     => array(
                  array(
                        'name'    => __( 'Member position', 'sweetthemes' ),
                        'desc'    => __( 'Set the member position', 'sweetthemes' ),
                        'id'      => $prefix . 'member_position',
                        'type'    => 'text',
                        'default' => 'Director'
                  ),
                  array(
                        'name'    => __( 'Member email', 'sweetthemes' ),
                        'desc'    => __( 'Set the member email', 'sweetthemes' ),
                        'id'      => $prefix . 'member_email',
                        'type'    => 'text',
                        'default' => 'Email@email.com'
                  ),
                  array(
                        'name'    => __( 'Member phone', 'sweetthemes' ),
                        'desc'    => __( 'Set the member phone', 'sweetthemes' ),
                        'id'      => $prefix . 'member_phone',
                        'type'    => 'text',
                        'default' => '+1 234 567 890'
                  ),
                  array(
                        'name'    => __( 'Facebook profile', 'sweetthemes' ),
                        'desc'    => __( 'Set the facebook URL', 'sweetthemes' ),
                        'id'      => $prefix . 'facebook_profile',
                        'type'    => 'text',
                        'default' => 'https://www.facebook.com/sweetthemes/'
                  ),
                  array(
                        'name'    => __( 'Twitter profile', 'sweetthemes' ),
                        'desc'    => __( 'Set the twitter profile', 'sweetthemes' ),
                        'id'      => $prefix . 'twitter_profile',
                        'type'    => 'text',
                        'default' => 'envato'
                  ),
                  array(
                        'name'    => __( 'Linkedin profile', 'sweetthemes' ),
                        'desc'    => __( 'Set the linkedin URL', 'sweetthemes' ),
                        'id'      => $prefix . 'linkedin_profile',
                        'type'    => 'text',
                        'default' => 'https://www.linkedin.com/'
                  ),
                  array(
                        'name'    => __( 'Vimeo', 'sweetthemes' ),
                        'desc'    => __( 'Set the vimeo URL', 'sweetthemes' ),
                        'id'      => $prefix . 'vimeo_url',
                        'type'    => 'text',
                        'default' => 'https://vimeo.com/'
                  ),
                  array(
                        'name'    => __( 'Profile link text', 'sweetthemes' ),
                        'desc'    => __( 'Set the profile link text', 'sweetthemes' ),
                        'id'      => $prefix . 'profile_link_text',
                        'type'    => 'text',
                        'default' => 'view profile'
                  ),
                  array(
                        'name'    => __( '"Contact Details" title text', 'sweetthemes' ),
                        'desc'    => __( 'Set the "Contact Details" title text', 'sweetthemes' ),
                        'id'      => $prefix . 'contact_details_title_text',
                        'type'    => 'text',
                        'default' => 'Contact Details'
                  ),
                  array(
                        'name'    => __( '"Skills" title text', 'sweetthemes' ),
                        'desc'    => __( 'Set the "Skills" title text', 'sweetthemes' ),
                        'id'      => $prefix . 'skills_title_text',
                        'type'    => 'text',
                        'default' => 'Skills'
                  ),
                  array(
                        'name'    => __( 'Progress bar 1 : name', 'sweetthemes' ),
                        'desc'    => __( 'Set the Progress bar 1 name', 'sweetthemes' ),
                        'id'      => $prefix . 'progress_bar1_name',
                        'type'    => 'text',
                        'default' => 'WordPress'
                  ),
                  array(
                        'name'    => __( 'Progress bar 1 : percentage value', 'sweetthemes' ),
                        'desc'    => __( 'Set the Progress bar 1 : percentage value', 'sweetthemes' ),
                        'id'      => $prefix . 'progress_bar1_percentage',
                        'type'    => 'text',
                        'default' => '90'
                  ),
                  array(
                        'name'    => __( 'Progress bar 2 : name', 'sweetthemes' ),
                        'desc'    => __( 'Set the Progress bar 2 : name', 'sweetthemes' ),
                        'id'      => $prefix . 'progress_bar2_name',
                        'type'    => 'text',
                        'default' => 'WordPress'
                  ),
                  array(
                        'name'    => __( 'Progress bar 2 : percentage value', 'sweetthemes' ),
                        'desc'    => __( 'Set the Progress bar 2 : percentage value', 'sweetthemes' ),
                        'id'      => $prefix . 'progress_bar2_percentage',
                        'type'    => 'text',
                        'default' => '90'
                  ),
                  array(
                        'name'    => __( 'Progress bar 3 : name', 'sweetthemes' ),
                        'desc'    => __( 'Set the Progress bar 3 : name', 'sweetthemes' ),
                        'id'      => $prefix . 'progress_bar3_name',
                        'type'    => 'text',
                        'default' => 'WordPress'
                  ),
                  array(
                        'name'    => __( 'Progress bar 3 : percentage value', 'sweetthemes' ),
                        'desc'    => __( 'Set the Progress bar 3 : percentage value', 'sweetthemes' ),
                        'id'      => $prefix . 'progress_bar3_percentage',
                        'type'    => 'text',
                        'default' => '90'
                  ),
                  array(
                        'name'    => __( 'Areas of Expertise title text', 'sweetthemes' ),
                        'desc'    => __( 'Set the Areas of Expertise title text', 'sweetthemes' ),
                        'id'      => $prefix . 'areas_expertise_title_text',
                        'type'    => 'text',
                        'default' => 'Areas of Expertise'
                  ),
                  array(
                        'name'    => __( 'Areas of Expertise content', 'sweetthemes' ),
                        'desc'    => __( 'Set the Areas of Expertise content', 'sweetthemes' ),
                        'id'      => $prefix . 'areas_expertise_content',
                        'type'    => 'wysiwyg',
                        'options' => array( 'textarea_rows' => 5, ),
                  ),
                  array(
                        'name'    => __( 'Education title text', 'sweetthemes' ),
                        'desc'    => __( 'Set the Areas of Expertise title text', 'sweetthemes' ),
                        'id'      => $prefix . 'education_title_text',
                        'type'    => 'text',
                        'default' => 'Education'
                  ),
                  array(
                        'name'    => __( 'Education content', 'sweetthemes' ),
                        'desc'    => __( 'Set the Areas of Expertise content', 'sweetthemes' ),
                        'id'      => $prefix . 'education_content',
                        'type'    => 'wysiwyg',
                        'options' => array( 'textarea_rows' => 5, ),
                  ),
            ),
      ...
      */
      ...
      $meta_boxes['post_metaboxs'] = array(
            ...
            'title'      => __( 'MT Post Layout', 'sweetthemes' ),
            ...
            'fields'     => array(
                  array(
                        'name'    => __( 'Rewrite Theme Options?', 'sweetthemes' ),
                        'desc'    => __( 'If "Yes" - Page Options will rewrite Theme Options', 'sweetthemes' ),
                        'id'      => 'select_post_layout',
                        'type'    => 'select',
                        'options' => array(
                            'inherit' => __( 'Inherit from Theme Panel', 'sweetthemes' ),
                            'left-sidebar' => __( 'Left Sidebar', 'sweetthemes' ),
                            'right-sidebar' => __( 'Right Sidebar', 'sweetthemes' ),
                            'no-sidebar' => __( 'No Sidebar', 'sweetthemes' ),
                        ),
                        'default' => 'inherit',
                  ),
                  array(
                        'name'    => __( 'Select Sidebar', 'sweetthemes' ),
                        'desc'    => __( '', 'sweetthemes' ),
	...
	foreach ( $menus as $menu ) {
      ...
      $meta_boxes['page_metaboxs'] = array(
            'id'         => 'page_metaboxs',
            'title'      => __( 'ST Custom Options', 'sweetthemes' ),
            'pages'      => array( 
                                    'page', 
                                    'post', 
                                    'testimonial', 
            ...
            'fields'     => array(
                  ...
                  */
                  ...
                  array(
                        'name'    => __( 'Select Revolution Slider', 'sweetthemes' ),
                        'desc'    => __( '', 'sweetthemes' ),
                  ...
                  array(
                        'name'    => __( 'Page title-breadcrumbs', 'sweetthemes' ),
                        'desc'    => __( '', 'sweetthemes' ),
                        'id'      => 'breadcrumbs_on_off',
                        'type'    => 'select',
                        'options' => array(
                              'no' => __( 'Off - Hide title-breadcrumbs area', 'sweetthemes' ),
                              'yes' => __( 'On - Show title-breadcrumbs area', 'sweetthemes' ),
                        ),
                        'default' => 'yes',
                  ),
                  array(
                        'name' => __( 'Breadcrumbs Image', 'sweetthemes' ),
                        'desc' => __( 'Upload an image or enter a URL.', 'sweetthemes' ),
                        'id'   => 'breadcrumbs_page_image',
                        'type' => 'file',
                  ),
                  ...
                  */
                  ...
                  array(
                        'name'    => __( 'Page top/bottom spacing', 'sweetthemes' ),
                        'desc'    => __( '', 'sweetthemes' ),
                        'id'      => 'page_spacing',
                        'type'    => 'select',
                        'options' => array(
                              'high-padding' => __( 'High Padding', 'sweetthemes' ),
                              'no-padding' => __( 'No Padding', 'sweetthemes' ),
                              'no-padding-top' => __( 'No Padding top', 'sweetthemes' ),
                              'no-padding-bottom' => __( 'No Padding bottom', 'sweetthemes' ),
                        ),
                        'default' => 'high-padding',
                  ),
                  array(
                        'name' => __( 'Disable Page Preloader', 'sweetthemes' ),
                        'desc' => __( 'Check to disable page preloader', 'sweetthemes' ),
                        'id'   => 'mt_page_preloader_status',
                        'type' => 'checkbox',
                  ),
                  array(
                        'name'    => __( 'Page Preloader Background Color', 'sweetthemes' ),
                        'desc'    => __( 'Set the background color of the Page Preloader(Default: #04ABE9)', 'sweetthemes' ),
                  ...
                  */
                  ...
                  array(
                        'name' => __( 'Disable Footer Row #1', 'sweetthemes' ),
                        'desc' => __( 'Check to disable footer row 1 (if enabled from Theme Options Panel)', 'sweetthemes' ),
                        'id'   => 'mt_footer_row1_status',
                        'type' => 'checkbox',
                  ),
                  array(
                        'name' => __( 'Disable Footer Row #2', 'sweetthemes' ),
                        'desc' => __( 'Check to disable footer row 2 (if enabled from Theme Options Panel)', 'sweetthemes' ),
                        'id'   => 'mt_footer_row2_status',
                        'type' => 'checkbox',
                  ),
                  array(
                        'name' => __( 'Disable Footer Row #3', 'sweetthemes' ),
                        'desc' => __( 'Check to disable footer row 3 (if enabled from Theme Options Panel)', 'sweetthemes' ),
                        'id'   => 'mt_footer_row3_status',
                        'type' => 'checkbox',
                  ),
                  array(
                        'name' => __( 'Disable Footer Bottom Bar', 'sweetthemes' ),
                        'desc' => __( 'Check to disable footer bottom copyright bar', 'sweetthemes' ),
      ...
      */
      $meta_boxes['projects_metaboxs'] = array(
            'id'         => 'projects_metaboxs',
            'title'      => __( 'ST Projects Custom Options', 'sweetthemes' ),
            'pages'      => array( 'st_projects' ), // Post type
            'context'    => 'normal',
            'priority'   => 'high',
            'show_names' => true, // Show field names on the left
            'fields'     => array(
                  ...
                  array(
                        'name' => __( 'Breadcrumbs Image', 'sweetthemes' ),
                        'desc' => __( 'Upload an image or enter a URL.', 'sweetthemes' ),
                        'id'   => 'breadcrumbs_case_image',
                        'type' => 'file',
                  ),
                  array(
                        'name'       => __( 'Client Name', 'sweetthemes' ),
                        'desc'       => __( '', 'sweetthemes' ),
                        'id'         => 'st_client_name',
                        'type'       => 'text',
                  ),
                  array(
                        'name'       => __( 'Tags', 'sweetthemes' ),
                        'desc'       => __( '', 'sweetthemes' ),
                        'id'         => 'st_project_tags',
                        'type'       => 'text',
                  )
      ...
      $meta_boxes['pagesdark_metaboxs'] = array(
            'id'         => 'pagesdark_metaboxs',
            'title'      => __( 'Dark mode Custom Options', 'sweetthemes' ),
            ...
            'fields'     => array(
                  ...
                  */
                  array(
                        'name' => '<h1>Dark mode Options</h1>',
                        'desc' => 'These options replaces the Theme Options for current page.',
                        'type' => 'title',
                        'id' => $prefix . 'test_title'
                  ),
                  array(
                        'name'    => __( 'Dark mode switch', 'sweetthemes' ),
                        'desc'    => __( '', 'sweetthemes' ),
                        'id'      => 'darkmode_on_off',
                        'type'    => 'select',
                        'options' => array(
                              'no' => __( 'Off - Disable dark mode', 'sweetthemes' ),
                              'yes' => __( 'On - Enable dark mode', 'sweetthemes' ),
                        ),
                        'default' => 'off',
                  ),
                  array(
                        'name'       => __( 'Primary color', 'sweetthemes' ),
                        'desc'       => __( '', 'sweetthemes' ),
                  ...
                  array(
                        'name' => __( 'Custom logo', 'sweetthemes' ),
                        'desc' => __( 'Upload an image or enter a URL.', 'sweetthemes' ),
                        'id'   => 'dark_custom_logo',
                        'type' => 'file',
                  ),
                  array(
                        'name'       => __( 'Header transparent', 'sweetthemes' ),
                        'desc'       => __( 'Make header transparent', 'sweetthemes' ),
                        'id'         => 'dark_header_transparent',
                        'type'       => 'checkbox',
                  ),
                  array(
                        'name'       => __( 'Header sticky background', 'sweetthemes' ),
                        'desc'       => __( '', 'sweetthemes' ),
                        'id'         => 'dark_header_sticky_bg',
                        'type'       => 'colorpicker',
                  ),
                  array(
                        'name'       => __( 'Header links color', 'sweetthemes' ),
                        'desc'       => __( '', 'sweetthemes' ),
                        'id'         => 'dark_header_links_color',
                        'type'       => 'colorpicker',
                  ),
                  array(
                        'name'       => __( 'Preloader background', 'sweetthemes' ),
                        'desc'       => __( '', 'sweetthemes' ),
                        'id'         => 'dark_preloader_bg',
                        'type'       => 'colorpicker',
                  )
            ),
      );
