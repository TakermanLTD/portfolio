...
function svc_post_grid_register_style_script(){
	wp_enqueue_style( 'svc-fontawosem-css', plugins_url('../assets/css/font-awesome.min.css', __FILE__ ), array(), '', 'all' );
	wp_enqueue_style( 'svc-front-css', plugins_url('../assets/css/front.css', __FILE__ ), array(), '' );
	wp_enqueue_style( 'svc-admin-css', plugins_url('../assets/css/admin.css', __FILE__ ), array(), '' );
	wp_register_style( 'svc-animate-css', plugins_url('../assets/css/animate.css', __FILE__),array(), '', 'all' );
	
	wp_register_style( 'svc-bootstrap-css', plugins_url('../assets/css/bootstrap.css', __FILE__),array(), '', 'all' );

	wp_register_style( 'svc-megnific-css', plugins_url('../assets/css/magnific-popup.css', __FILE__),array(), '', 'all' );
