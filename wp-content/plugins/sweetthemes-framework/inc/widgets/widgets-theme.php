...
/* ========= social_icons ===================================== */
class sweetthemes_address_social_icons extends WP_Widget {



    function __construct() {
        parent::__construct('sweetthemes_address_social_icons', esc_attr__('ST - Contact + Social links', 'sweetthemes'),array( 'description' => esc_attr__( 'ST - Contact information + Social icons', 'sweetthemes' ), ) );
    }
    ...
    public function widget( $args, $instance ) {
        ...
        <div class="sidebar-social-networks address-social-links">
            ...
            <?php if('on' == $instance['widget_contact_details']) { ?>
                <?php if(niva('mt_contact_address') || niva('mt_contact_email') || niva('mt_contact_phone')){ ?>
                    <div class="contact-details">
                        <?php if(niva('mt_contact_phone')) { ?>
                            <p><i class="fa fa-phone" aria-hidden="true"></i><?php echo esc_attr( niva('mt_contact_phone')); ?></p>
                        <?php } ?>
                        <?php if(niva('mt_contact_email')) { ?>
                            <p><i class="fa fa-envelope" aria-hidden="true"></i><?php echo esc_attr( niva('mt_contact_email')); ?></p>
                        <?php } ?>
                        <?php if(niva('mt_contact_address')) { ?>
                            <p><i class="fa fa-map-marker" aria-hidden="true"></i><?php echo esc_attr( niva('mt_contact_address')); ?></p>
                        <?php } ?>
                    </div>
                <?php } ?>
            <?php } ?>
            ...
            <?php if('on' == $instance['widget_social_icons']) { ?>
                ...
                <?php if ( niva('mt_social_fb') && niva('mt_social_fb') != '' ) { ?>
                    <li><a target="_blank" href="<?php echo esc_attr( niva('mt_social_fb') ) ?>"><i class="fa fa-facebook"></i></a></li>
                <?php } ?>
                <?php if ( niva('mt_social_tw') && niva('mt_social_tw') != '' ) { ?>
                    <li><a target="_blank" href="<?php echo esc_url( 'https://twitter.com/' . niva('mt_social_tw') ) ?>"><i class="fa fa-twitter"></i></a></li>
                <?php } ?>
    ...
    public function form( $instance ) {
        ...
        if ( isset( $instance[ 'widget_title' ] ) ) {
            ...
            $widget_title = esc_attr__( 'Social icons', 'sweetthemes' );
        }
        ?>

        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'widget_title' )); ?>"><?php esc_attr_e( 'Widget Title:','sweetthemes' ); ?></label> 
        ...
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_name('widget_contact_details')); ?>"><?php esc_attr_e( 'Show contact informations box','sweetthemes' ); ?></label>
        </p>
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_name('widget_social_icons')); ?>"><?php esc_attr_e( 'Show social icons','sweetthemes' ); ?></label>
        </p>
...
*/
        ?>
        <p><?php esc_attr_e( '* Social Network account must be set from ST - Theme Panel.','sweetthemes' ); ?></p>
        <?php 
    }
...
/* ========= Flickr_Feed_Widget ===================================== */
class sweetthemes_flickr extends WP_Widget { 
    
    function __construct() {
        $widget_ops = array('description' => esc_attr__('Display latest Flickr Feed','sweetthemes') );
        $control_ops = array( 'width' => 60, 'height' => 60, 'id_base' => 'flickr' );
        parent::__construct( 'sweetthemes_flickr', esc_attr__('ST - Flickr Feed','sweetthemes'), $widget_ops, $control_ops );
    }
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php esc_attr_e('Title of the Widget', 'sweetthemes'); ?></label>
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'title' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'title' )); ?>" value="<?php echo esc_attr($instance['title']); ?>" />
        </p>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'username' )); ?>"><?php esc_attr_e('Your Flickr ID:', 'sweetthemes'); ?></label>
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'username' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'username' )); ?>" value="<?php echo esc_attr($instance['username']); ?>" /><br /><a href="<?php echo esc_url_raw( 'http://idgettr.com/' ); ?>" target="_blank"><?php esc_attr_e('Flickr idGettr','sweetthemes'); ?></a>
        </p>

        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'pics' )); ?>"><?php esc_attr_e('Number of Photos to show:', 'sweetthemes'); ?></label>
...
/* ========= sweetthemes_recent_entries_with_thumbnail ===================================== */
class sweetthemes_recent_entries_with_thumbnail extends WP_Widget {

    /**
     * Register widget with WordPress.
     */
    function __construct() {
        parent::__construct('sweetthemes_recent_entries_with_thumbnail', esc_attr__('ST - Recent Posts with thumbnails', 'sweetthemes'),array( 'description' => esc_attr__( 'ST - Recent Posts with thumbnails', 'sweetthemes' ), ) );
    }
    ...
    public function widget( $args, $instance ) {
        ...
        foreach ($recentposts as $post) {
            $thumbnail_src = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ),'sweetthemes_post_widget_pic100x100' );

            $myContent .= '<li class="row">';
                $myContent .= '<div class="vc_col-md-4 post-thumbnail relative">';
                    $myContent .= '<a href="'. get_permalink($post->ID) .'">';
                        if($thumbnail_src) { $myContent .= '<img src="'. $thumbnail_src[0] . '" alt="'. $post->post_title .'" />';
                        }else{ $myContent .= '<img src="http://placehold.it/150x150" alt="'. $post->post_title .'" />'; }
                    $myContent .= '</a>';
                $myContent .= '</div>';
                $myContent .= '<div class="vc_col-md-8 post-details">';
    ...
    public function form( $instance ) {
        ...
        if ( isset( $instance[ 'recent_posts_title' ] ) ) {
            ...
            $recent_posts_title = esc_attr__( 'Recent posts', 'sweetthemes' );
        }
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'recent_posts_title' )); ?>"><?php esc_attr_e( 'Widget Title:','sweetthemes' ); ?></label> 
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'recent_posts_number' )); ?>"><?php esc_attr_e( 'Number of posts:','sweetthemes' ); ?></label> 
...
/* ========= Tabs Widget ===================================== */
class sweetthemes_popular_recent_tabs extends WP_Widget {

    /**
     * Register widget with WordPress.
     */
    function __construct() {
        parent::__construct('sweetthemes_popular_recent_tabs', esc_attr__('ST - TABS: Random, Recent posts', 'sweetthemes'),array( 'description' => esc_attr__( 'ST - TABS: Random, Recent posts', 'sweetthemes' ), ) );
    }
        ...
        $myContent .= '<div class="widget_body">';
            ...
            $myContent .= '<div class="tab-content">';
                ...
                foreach ($popularposts as $post) {
                    $thumbnail_src = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ),'sweetthemes_post_pic700x450' );
                    ...
                    $myContent .= '<div class="recent-post">';
                        ...
                        $myContent .= '<div class="post-description">'.sweetthemes_excerpt_limit($excerpt,10).'</div>';
                    $myContent .= '</div>';
                }
                $myContent .= '</div>';
    ...
    public function form( $instance ) {
        ...
        if ( isset( $instance[ 'recent_posts_title' ] ) ) {
            ...
            $recent_posts_title = esc_attr__( 'Tab Widget', 'sweetthemes' );
        }
        ...
        if ( isset( $instance[ 'title_first_tab' ] ) ) {
            ...
            $title_first_tab = esc_attr__( 'Random posts', 'sweetthemes' );
        }
        # Number of posts
        ...
        if ( isset( $instance[ 'title_second_tab' ] ) ) {
            ...
            $title_second_tab = esc_attr__( 'Recent posts', 'sweetthemes' );
        }
        # Number of posts
        if ( isset( $instance[ 'recent_posts_number' ] ) ) {
            $recent_posts_number = $instance[ 'recent_posts_number' ];
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'title_first_tab' )); ?>"><?php esc_attr_e( 'Number of recent posts:','sweetthemes' ); ?></label> 
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'recent_posts_number' )); ?>"><?php esc_attr_e( 'Number of recent posts:','sweetthemes' ); ?></label> 
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'recent_posts_number' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'recent_posts_number' )); ?>" type="text" value="<?php echo esc_attr( $recent_posts_number ); ?>">
        </p>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'title_second_tab' )); ?>"><?php esc_attr_e( 'Number of popular posts:','sweetthemes' ); ?></label> 
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'popular_posts_number' )); ?>"><?php esc_attr_e( 'Number of popular posts:','sweetthemes' ); ?></label> 
...
/* ========= sweetthemes_post_thumbnails_slider ===================================== */
class sweetthemes_post_thumbnails_slider extends WP_Widget {

    /**
     * Register widget with WordPress.
     */
    function __construct() {
        parent::__construct('sweetthemes_post_thumbnails_slider', esc_attr__('ST - Post thumbnails slider', 'sweetthemes'),array( 'description' => esc_attr__( 'ST - Post thumbnails slider', 'sweetthemes' ), ) );
    }
    ...
    public function form( $instance ) {
        ...
        if ( isset( $instance[ 'recent_posts_title' ] ) ) {
            ...
            $recent_posts_title = esc_attr__( 'Post thumbnails slider', 'sweetthemes' );
        }
...
/* ========= sweetthemes_social_share ===================================== */
class sweetthemes_social_share extends WP_Widget {



    function __construct() {
        parent::__construct('sweetthemes_social_share', esc_attr__('ST - Social Share Icons', 'sweetthemes'),array( 'description' => esc_attr__( 'ST - Social Share Icons', 'sweetthemes' ), ) );
    }
        ...
        <div class="sidebar-share-social-links">
            ...
            <ul class="share-social-links">
                ...
                <li class="pinterest">
                    ...
                    <?php /*<a href="http://pinterest.com/pin/create/button/?url=<?php echo esc_attr($siteurl); ?>&amp;media=<?php echo esc_attr(sweetthemes('mt_logo', 'url')); ?>&amp;description=<?php echo esc_attr($sitedescription); ?>" target="_blank"><i class="fa fa-pinterest"></i></a>*/ ?>
                </li>
    ...
    public function form( $instance ) {
        ...
        <p><?php esc_attr_e( 'Check what Social SHARE Buttons do you want to display','sweetthemes' ); ?></p>
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_name('share-facebook')); ?>"><?php esc_attr_e( 'Facebook','sweetthemes' ); ?></label>
        </p>
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_name('share-twitter')); ?>"><?php esc_attr_e( 'Twitter','sweetthemes' ); ?></label>
        </p>
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_name('share-linkedin')); ?>"><?php esc_attr_e( 'Linkedin','sweetthemes' ); ?></label>
        </p>
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_name('share-googleplus')); ?>"><?php esc_attr_e( 'Google Plus','sweetthemes' ); ?></label>
        </p>
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_name('share-digg')); ?>"><?php esc_attr_e( 'Digg','sweetthemes' ); ?></label>
        </p>
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_name('share-pinterest')); ?>"><?php esc_attr_e( 'Pinterest','sweetthemes' ); ?></label>
        </p>
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_name('share-reddit')); ?>"><?php esc_attr_e( 'Reddit','sweetthemes' ); ?></label>
        </p>
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_name('share-stumbleupon')); ?>"><?php esc_attr_e( 'Stumbleupon','sweetthemes' ); ?></label>
        </p>
...
// Register Widgets
function sweetthemes_register_widgets() {
    register_widget( 'sweetthemes_address_social_icons' );
    register_widget( 'sweetthemes_social_share' );
    register_widget( 'sweetthemes_flickr' );
    register_widget( 'sweetthemes_recent_entries_with_thumbnail' );
    register_widget( 'sweetthemes_post_thumbnails_slider' );
    register_widget( 'sweetthemes_popular_recent_tabs' );

}
add_action( 'widgets_init', 'sweetthemes_register_widgets' );
?>
